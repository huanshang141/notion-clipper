...
export const MESSAGE_ACTIONS = {
  ...
  OPEN_INLINE_EDITOR: 'OPEN_INLINE_EDITOR',
  GET_EDITOR_DRAFT: 'GET_EDITOR_DRAFT',
  UPDATE_EDITOR_DRAFT: 'UPDATE_EDITOR_DRAFT',
  UPDATE_EDITOR_DRAFT_BY_URL: 'UPDATE_EDITOR_DRAFT_BY_URL',
  GET_EDITOR_DRAFT_BY_URL: 'GET_EDITOR_DRAFT_BY_URL',
